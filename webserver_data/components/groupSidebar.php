...
<aside class="gruppen-sidebar" id="gruppenSidebar">
    ...
    <nav class="sidebar-nav brown darken-4">
        ...
        <a href="../groupChat.php?groupId=<?= $currentGroupId ?>" class="sidebar-nav-item<?= sidebarActive('chat', $activeNav) ?>">
            <i class="material-icons">chat</i>
            Gruppenchat
        </a>

        <a href="kalender.php?groupId=<?= $currentGroupId ?>" class="sidebar-nav-item<?= sidebarActive('kalender', $activeNav) ?>">
        ...
        <a href="projekte.php?groupId=<?= $currentGroupId ?>" class="sidebar-nav-item<?= sidebarActive('projekte', $activeNav) ?>">
            <i class="material-icons">folder_special</i>
            Projekte
        </a>

        <a href="../aufgabenAnsicht.php?groupId=<?= $currentGroupId ?>" class="sidebar-nav-item<?= sidebarActive('aufgaben', $activeNav) ?>">
            <i class="material-icons">task_alt</i>
            Aufgaben
        </a>

        <a href="../ressourcen.php?groupId=<?= $currentGroupId ?>" class="sidebar-nav-item<?= sidebarActive('ressourcen', $activeNav) ?>">
        ...
        <a href="./settings.php?groupId=<?= $currentGroupId ?>" class="sidebar-nav-item<?= sidebarActive('einstellungen', $activeNav) ?>">
